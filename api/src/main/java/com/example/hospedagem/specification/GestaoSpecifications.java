...
/**
 * Predicados dinâmicos para filtrar gestões no banco.
 * Cada filtro é opcional; os presentes são combinados com AND.
 */
public final class GestaoSpecifications {

    private GestaoSpecifications() {
    }

    public static Specification<Gestao> comFiltro(GestaoFiltro filtro) {
