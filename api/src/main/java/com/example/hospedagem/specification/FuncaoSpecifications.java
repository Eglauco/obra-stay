...
/**
 * Predicados dinâmicos para filtrar funções no banco.
 * Cada filtro é opcional; os presentes são combinados com AND.
 */
public final class FuncaoSpecifications {

    private FuncaoSpecifications() {
    }

    public static Specification<Funcao> comFiltro(FuncaoFiltro filtro) {
