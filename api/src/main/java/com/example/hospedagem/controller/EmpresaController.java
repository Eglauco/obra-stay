...
public class EmpresaController {
    ...
    /**
     * Exporta as empresas filtradas (sem paginação) para Excel.
     * Declarado antes de "/{id}" para não ser capturado como path variable.
     */
    @GetMapping("/exportar")
    public ResponseEntity<byte[]> exportar(
        ...
        byte[] conteudo = service.exportar(new EmpresaFiltro(id, nome));
        return PlanilhaExcel.resposta(conteudo, "empresas");
    }
